                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button type="submit" name="submit" class="btn btn-dark btn-block" style="background-color: #DE5C6C; border-color: #CF5E6D;">Create Account</button></div>
                                        </div>
                                    </form>
                                </div>
