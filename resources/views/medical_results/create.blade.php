<div class="container">
    <h1>Create Medical Result</h1>
    <form action="{{ route('medical_results.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="medicalrecord_id" name="medicalrecord_id" required>
        </div>
        <div class="mb-3">
